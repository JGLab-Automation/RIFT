...
class PingPongLifeCycle(unittest.TestCase):
    ...
    def test03_Cloud_Account_Add(self):
        ...
        acct_type = fw.get_cloud_acct_type(const.lp_addr_default[0], const.header_default, self.proj_name[0], const.cloud_acct_name[0])
    ...
    def test04_Cloud_Account_Configure(self):
        ...
        fw.cloud_acct_config_openstack(const.lp_addr_default[0], const.header_default, self.proj_name[0], const.cloud_acct_name[0],
                                       const.vim_os_key, const.vim_os_secret, const.vim_os_auth_url, const.vim_os_tenant
                                       )
        status = fw.cloud_acct_status(const.lp_addr_default[0], const.header_default, self.proj_name[0], const.cloud_acct_name[0])
        if status == "success":
    ...
    def test06_NS_Create(self):
        ...
        conf_name = fw.get_ns_instance_config(const.lp_addr_default[0], const.header_default, self.proj_name[0], self.nsr_id[0], "name")
        conf_state = fw.get_ns_instance_config(const.lp_addr_default[0], const.header_default, self.proj_name[0], self.nsr_id[0], "status")
