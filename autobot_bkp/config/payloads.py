...
def cloud_acct_config_default(acct_name, acct_type, key, secret, auth_url, usr_domain, proj_domain, tenant, region, mgmt_net, float_ip_pool_net):
    payload = \
        {
            "rw-cloud:account":
                [
